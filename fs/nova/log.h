 ...
 */
struct nova_file_write_entry {	// [yhc] Log entry size: 64Bytes.
	u8	entry_type;
...
// NOVA DEDUP //
int nova_invalidate_write_entry(struct super_block *sb, struct nova_file_write_entry *entry, int reassign, unsigned int num_free);
